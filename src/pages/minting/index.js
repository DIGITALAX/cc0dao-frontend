...
const abi = [
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "contract DigitalaxGarmentNFT",
        name: "",
        type: "address",
      },
    ],
  ...
  const handleContributeClick = async () => {
    ...
    try {
      const metaJson = {
        ...
        external_url: "http://residents.digitalax.xyz/",
        attributes: [
          {
      ...
      <div className="bg-black mintingcontainer">
        ...
        <div className="mintingtext">
          <p className="text-gray-50 minttext">
            Enter the information in the fillout boxes below to mint your 1155
            NFT and contribute to our open sourced material, pattern, texture
            on-chain libraries. Your contribution can be used in master garments
            by other designers, artists, creators— it is open sourced. Open
            source doesn’t mean without monetisation. Our infrastructure is
            being built to eventually support automated fractional royalties for
            any designer as they contribute to open source libraries that can be
            leveraged in both the digital and physical dimensions. A
            decentralised commercial model.
          </p>
          <p className="text-gray-50 minttext mt-5">
            Although we can’t automatically enforce in smart contract code this
            fractional cross-chain, cross-realm royalty distribution as of yet,
            we still are continuing to prove out the model and hope that those
            that use these open source prints contribute a fractional portion of
            the sales back to the DIGITALAX, as we have done and plan to do for
            anyone contributing to our on-chain libraries going forward. Your
            NFT is minted on Matic Network for 99% more energy efficiency than
            the Ethereum or Bitcoin blockchains. Through our MultiToken bridge
            these NFTs can be bridged back to Ethereum for additional
            ...
            <div className="flex justify-center">
              <div className="w-1/2 flex flex-col mr-10">
                <Input
                  ...
                  value={residentId}
                  onChange={(e) => setValue(setResidentId, e.target.value)}
                />
                {/* <Input
