...
const apiRequest = (chainId, gql, params) => {
  console.log(getAPIUrlByChainId(chainId));
  return request(getAPIUrlByChainId(chainId), gql, params);
};
...
export const getCC0CollectionGroups = async (chainId) =>
  apiRequest(chainId, COLLECTION_GROUPS);

export const getDigitalaxGarmentCollections = async (chainId) =>
  apiRequest(chainId, DIGITALAX_GARMENT_COLLECTIONS);

export const getCC0CollectionGroupById = async (chainId, id) =>
